...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-forcefields-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-forcefields-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openff-forcefields
# for installing globally
pixi global install openff-forcefields
```
...
It is possible to list all of the versions of `openff-forcefields` available on your platform:
...
```
pixi search openff-forcefields --channel conda-forge
```
